...
export const Route = createFileRoute("/courses/")({
  head: () => ({
    meta: [
      { title: "সব কোর্স - শিক্ষা" },
      { name: "description", content: "আমাদের সব কোর্স ব্রাউজ করুন।" },
    ],
  }),
      ...
      <div className="mx-auto w-full max-w-7xl flex-1 px-4 py-8">
        ...
        <div className="mb-6 flex flex-col gap-4 md:flex-row">
          <div className="relative flex-1">
            ...
            <Input placeholder={searchPlaceholder} className="pl-10" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} />
          </div>
          <div className="flex flex-wrap gap-2">
            <Button variant={selectedCategory === "" ? "default" : "outline"} size="sm" onClick={() => setSelectedCategory("")}>{allLabel}</Button>
            {categories.map((cat) => (
