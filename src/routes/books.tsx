...
export const Route = createFileRoute("/books")({
  head: () => ({
    meta: [
      { title: "বই - ZeroSpace Architect" },
      { name: "description", content: "আর্কিটেকচার, ডিজাইন ও কনস্ট্রাকশন বিষয়ক সেরা বইসমূহ অনলাইনে কিনুন।" },
    ],
  }),
  component: BooksPage,
});
...
const books: Book[] = [
  {
    ...
    description: "আর্কিটেকচারাল ডিজাইনের মৌলিক ধারণা, স্কেচ এবং প্ল্যানিং নিয়ে বিস্তারিত গাইডবুক।",
  },
  {
    id: "b2",
  ...
  },
  {
    ...
    description: "RCC, স্টিল স্ট্রাকচার এবং ফাউন্ডেশন ডিজাইন সম্পর্কিত সম্পূর্ণ রেফারেন্স।",
  },
  {
    id: "b4",
    ...
    originalPrice: 600,
    rating: 4,
    cover: "https://images.unsplash.com/photo-1532153975070-2e9ab71f1b14?w=400&h=600&fit=crop",
  ...
  },
  {
    ...
    description: "আউটডোর স্পেস, বাগান ও পার্ক ডিজাইনের কৌশল ও আইডিয়া।",
  },
];
            ...
            {books.map((book) => (
              <Card key={book.id} className="flex flex-col overflow-hidden transition-shadow hover:shadow-lg">
                <div className="aspect-[3/4] overflow-hidden bg-muted">
                  <img src={book.cover} alt={book.title} className="h-full w-full object-cover transition-transform hover:scale-105" loading="lazy" />
                </div>
                <CardHeader>
                  ...
                  <div className="flex items-center gap-1">
                    {Array.from({ length: 5 }).map((_, i) => (
                      <Star key={i} className={`h-4 w-4 ${i < book.rating ? "fill-yellow-400 text-yellow-400" : "text-muted-foreground"}`} />
                    ))}
                  </div>
                </CardHeader>
