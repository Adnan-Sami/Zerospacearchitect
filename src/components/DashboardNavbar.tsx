  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <div className="flex flex-1">
        ...
        {/* Main content */}
        <main className="flex-1 p-6">{/* content injected by pages */}</main>
      </div>
    </div>
  );
}
...
/**
 * Wrapper component for student pages that provides the sidebar layout.
 * Usage: <StudentLayout>...content...</StudentLayout>
 */
