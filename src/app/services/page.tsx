...
export default function ServicesPage() {
  ...
  const s1t = useSiteContent("services.1.title");
  const s1d = useSiteContent("services.1.desc");
  const s2t = useSiteContent("services.2.title");
  const s2d = useSiteContent("services.2.desc");
  const s3t = useSiteContent("services.3.title");
  const s3d = useSiteContent("services.3.desc");
  const s4t = useSiteContent("services.4.title");
  const s4d = useSiteContent("services.4.desc");
  const s5t = useSiteContent("services.5.title");
  const s5d = useSiteContent("services.5.desc");
  const s6t = useSiteContent("services.6.title");
  const s6d = useSiteContent("services.6.desc");
