    ...
    <div className="max-w-5xl">
      <div className="mb-6">
        ...
        <p className="text-sm text-muted-foreground">
          হোম, কোর্স, বই, ডিজাইন ও কনসালটেন্সি, সাপোর্ট — সব পেজের টেক্সট ও
          ছবি এখানে এডিট করুন।
        </p>
      </div>
      ...
      <div className="relative mb-4 max-w-md">
        ...
        <Input
          className="pl-9"
          placeholder="পেজ, লেবেল, বা টেক্সট সার্চ..."
          value={search}
                  ...
                  <CardContent className="flex items-start justify-between gap-3 p-3">
                    <div className="min-w-0 flex-1">
                      <p className="text-sm font-semibold">
                        {r.label}{" "}
                        {r.saved && (
                          <span className="ml-2 rounded bg-green-100 px-2 text-xs text-green-700">
                            কাস্টম
                          </span>
                        )}
                      </p>
                      ...
                      {r.type === "image" ? (
                        r.value ? (
                          <Image
                            ...
                            width={200}
                            height={64}
                            className="mt-1 h-16 rounded object-cover"
                          />
                        ) : (
                        ...
                        <p className="mt-1 line-clamp-2 whitespace-pre-line text-sm">
                          {r.value || (
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-h-[90vh] max-w-2xl overflow-y-auto">
          <DialogHeader>
            <DialogTitle>{editing?.label} এডিট</DialogTitle>
          </DialogHeader>
          {editing && (
            <div className="space-y-3">
                  ...
                  <div>
                    ...
                    {uploading && (
                      <p className="mt-1 text-xs text-muted-foreground">
                        <Upload className="inline h-3 w-3 animate-pulse" />{" "}
                        আপলোড হচ্ছে...
                      </p>
                    )}
                  </div>
              ...
              <p className="text-xs text-muted-foreground">
                ডিফল্ট: {REGISTRY_BY_KEY[editing.key]?.defaultValue || "(খালি)"}
              </p>
