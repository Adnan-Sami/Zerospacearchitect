...
import { StudentLayout } from "@/components/DashboardNavbar";
                        ...
                        {(repliesMap[t.id] ?? []).map((r: any) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              >
                                <p
                                  className={`text-[10px] font-semibold mb-1 ${isAdmin ? "text-gray-400" : "text-sky-100"}`}
                                >
                                  {isAdmin ? "সাপোর্ট টিম" : "আপনি"}
                                </p>
                                ...
                                <p
                                  className={`text-[10px] mt-1 ${isAdmin ? "text-gray-400" : "text-sky-200"}`}
                                >
